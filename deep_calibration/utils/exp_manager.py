...
from deep_calibration.utils.wrappers import NormalizeActionWrapper
...
import deep_calibration.utils.import_envs  # noqa: F401 pytype: disable=import-error
from deep_calibration.utils.callbacks import SaveVecNormalizeCallback, TrialEvalCallback
from deep_calibration.utils.hyperparams_opt import HYPERPARAMS_SAMPLER
from deep_calibration.utils.utils import ALGOS, get_callback_list, get_latest_run_id, get_wrapper_class, linear_schedule
...
class ExperimentManager(object):
    ...
    def read_hyperparameters(self) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        ...
        hyperparams_path = os.path.join(script_dir, 'utils/hyperparams', f"{self.algo}.yml")
